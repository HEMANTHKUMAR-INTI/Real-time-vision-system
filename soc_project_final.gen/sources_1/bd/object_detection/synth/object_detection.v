...
//Date        : Sun Apr 12 13:05:42 2026
//Host        : LAPTOP-8D55SVFB running 64-bit major release  (build 9200)
//Command     : generate_target object_detection.bd
//Design      : object_detection
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "object_detection,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=object_detection,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "object_detection.hwdef" *) 
module object_detection
  ...
  wire axi_intc_0_irq;
  wire [9:0]axi_smc_ctrl_M00_AXI_ARADDR;
  wire axi_smc_ctrl_M00_AXI_ARREADY;
  wire axi_smc_ctrl_M00_AXI_ARVALID;
  wire [9:0]axi_smc_ctrl_M00_AXI_AWADDR;
  ...
  wire [8:0]axi_smc_ctrl_M01_AXI_ARADDR;
  wire axi_smc_ctrl_M01_AXI_ARREADY;
  wire axi_smc_ctrl_M01_AXI_ARVALID;
  wire [8:0]axi_smc_ctrl_M01_AXI_AWADDR;
  ...
  object_detection_axi_dma_0_0 axi_dma_0
       (.axi_resetn(rst_ps7_0_100M_peripheral_aresetn),
        ...
        .s_axi_lite_araddr(axi_smc_ctrl_M00_AXI_ARADDR),
        .s_axi_lite_arready(axi_smc_ctrl_M00_AXI_ARREADY),
        .s_axi_lite_arvalid(axi_smc_ctrl_M00_AXI_ARVALID),
        .s_axi_lite_awaddr(axi_smc_ctrl_M00_AXI_AWADDR),
        .s_axi_lite_awready(axi_smc_ctrl_M00_AXI_AWREADY),
        .s_axi_lite_awvalid(axi_smc_ctrl_M00_AXI_AWVALID),
        .s_axi_lite_bready(axi_smc_ctrl_M00_AXI_BREADY),
        .s_axi_lite_bresp(axi_smc_ctrl_M00_AXI_BRESP),
        .s_axi_lite_bvalid(axi_smc_ctrl_M00_AXI_BVALID),
        .s_axi_lite_rdata(axi_smc_ctrl_M00_AXI_RDATA),
        .s_axi_lite_rready(axi_smc_ctrl_M00_AXI_RREADY),
        .s_axi_lite_rresp(axi_smc_ctrl_M00_AXI_RRESP),
        .s_axi_lite_rvalid(axi_smc_ctrl_M00_AXI_RVALID),
        .s_axi_lite_wdata(axi_smc_ctrl_M00_AXI_WDATA),
        .s_axi_lite_wready(axi_smc_ctrl_M00_AXI_WREADY),
        .s_axi_lite_wvalid(axi_smc_ctrl_M00_AXI_WVALID),
  ...
  object_detection_axi_intc_0_0 axi_intc_0
       (.intr(axi_dma_0_mm2s_introut),
        .irq(axi_intc_0_irq),
        .s_axi_aclk(processing_system7_0_FCLK_CLK0),
        .s_axi_araddr(axi_smc_ctrl_M01_AXI_ARADDR),
        .s_axi_aresetn(rst_ps7_0_100M_peripheral_aresetn),
        .s_axi_arready(axi_smc_ctrl_M01_AXI_ARREADY),
        .s_axi_arvalid(axi_smc_ctrl_M01_AXI_ARVALID),
        .s_axi_awaddr(axi_smc_ctrl_M01_AXI_AWADDR),
        .s_axi_awready(axi_smc_ctrl_M01_AXI_AWREADY),
        .s_axi_awvalid(axi_smc_ctrl_M01_AXI_AWVALID),
        .s_axi_bready(axi_smc_ctrl_M01_AXI_BREADY),
        .s_axi_bresp(axi_smc_ctrl_M01_AXI_BRESP),
        .s_axi_bvalid(axi_smc_ctrl_M01_AXI_BVALID),
        .s_axi_rdata(axi_smc_ctrl_M01_AXI_RDATA),
        .s_axi_rready(axi_smc_ctrl_M01_AXI_RREADY),
        .s_axi_rresp(axi_smc_ctrl_M01_AXI_RRESP),
        .s_axi_rvalid(axi_smc_ctrl_M01_AXI_RVALID),
        .s_axi_wdata(axi_smc_ctrl_M01_AXI_WDATA),
        .s_axi_wready(axi_smc_ctrl_M01_AXI_WREADY),
        .s_axi_wstrb(axi_smc_ctrl_M01_AXI_WSTRB),
        .s_axi_wvalid(axi_smc_ctrl_M01_AXI_WVALID));
  object_detection_axi_smc_ctrl_0 axi_smc_ctrl
  ...
  object_detection_axi_smc_mem_0 axi_smc_mem
       (.M00_AXI_araddr(axi_smc_mem_M00_AXI_ARADDR),
        ...
        .aclk(processing_system7_0_FCLK_CLK0),
        .aresetn(rst_ps7_0_100M_peripheral_aresetn));
  object_detection_axis_data_fifo_0_0 axis_data_fifo_0
  ...
  object_detection_processing_system7_0_0 processing_system7_0
       (.DDR_Addr(DDR_addr),
        .DDR_BankAddr(DDR_ba),
        .DDR_CAS_n(DDR_cas_n),
        .DDR_CKE(DDR_cke),
  ...
  object_detection_rst_ps7_0_100M_0 rst_ps7_0_100M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
