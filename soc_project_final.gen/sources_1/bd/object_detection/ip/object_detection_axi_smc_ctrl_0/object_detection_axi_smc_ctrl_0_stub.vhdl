...
-- Date        : Sun Apr 12 13:10:09 2026
-- Host        : LAPTOP-8D55SVFB running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub {c:/Users/hemanth
--               kumar/soc_project_final/soc_project_final.gen/sources_1/bd/object_detection/ip/object_detection_axi_smc_ctrl_0/object_detection_axi_smc_ctrl_0_stub.vhdl}
-- Design      : object_detection_axi_smc_ctrl_0
...
entity object_detection_axi_smc_ctrl_0 is
  Port ( 
    aclk : in STD_LOGIC;
  ...
  attribute CHECK_LICENSE_TYPE of object_detection_axi_smc_ctrl_0 : entity is "object_detection_axi_smc_ctrl_0,bd_6701,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of object_detection_axi_smc_ctrl_0 : entity is "object_detection_axi_smc_ctrl_0,bd_6701,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=25,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of object_detection_axi_smc_ctrl_0 : entity is "yes";
end object_detection_axi_smc_ctrl_0;

architecture stub of object_detection_axi_smc_ctrl_0 is
  ...
  attribute X_INTERFACE_PARAMETER of aclk : signal is "XIL_INTERFACENAME CLK.aclk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN object_detection_processing_system7_0_0_FCLK_CLK0, ASSOCIATED_BUSIF M00_AXI:M01_AXI:S00_AXI, INSERT_VIP 0, ASSOCIATED_CLKEN s_sc_aclken";
  ...
  attribute X_CORE_INFO of stub : architecture is "bd_6701,Vivado 2024.2";
begin
end;
