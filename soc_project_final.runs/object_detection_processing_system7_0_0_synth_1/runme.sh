...
HD_PWD='C:/Users/hemanth kumar/soc_project_final/soc_project_final.runs/object_detection_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log object_detection_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source object_detection_processing_system7_0_0.tcl
