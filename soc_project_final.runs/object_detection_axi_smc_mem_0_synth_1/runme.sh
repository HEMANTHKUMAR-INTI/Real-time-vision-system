...
HD_PWD='C:/Users/hemanth kumar/soc_project_final/soc_project_final.runs/object_detection_axi_smc_mem_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log object_detection_axi_smc_mem_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source object_detection_axi_smc_mem_0.tcl
