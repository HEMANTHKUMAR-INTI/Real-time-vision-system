...
HD_PWD='C:/Users/hemanth kumar/soc_project_final/soc_project_final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log object_detection_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source object_detection_wrapper.tcl
