...
HD_PWD='C:/Users/hemanth kumar/soc_project_final/soc_project_final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log object_detection_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source object_detection_wrapper.tcl -notrace
